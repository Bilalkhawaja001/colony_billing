@extends('layouts.app')
@section('page_title','Water Tools')
@section('page_subtitle','Pre-billing water allocation controls: snapshot, adjustments, allocation preview.')
@section('content')
<div class="grid">
...
<div class="col-12 card soft"><a class="btn" href="/meters-readings">Back to Meters &amp; Readings Hub</a></div>

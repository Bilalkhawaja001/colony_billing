...
<div class="grid">
    <div class="col-12 card">
        ...
        <form method="post" action="/facilities-management/service-requests" class="fm-form">
            ...
            <div class="field wide"><label class="label">Component</label><select name="facility_component_id"><option value="">No component selected</option>@foreach($components as $component)<option value="{{ $component->id }}">{{ $component->facility_code }} - {{ $component->component_type }} {{ $component->component_name }}</option>@endforeach</select></div>

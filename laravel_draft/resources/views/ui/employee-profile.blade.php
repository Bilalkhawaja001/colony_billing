...
<div class="ep-shell">
    ...
    <div class="ep-card">
      <div class="ep-card-head">
        <div>
          ...
          <div class="ep-card-sub">Employee appears as Family Head; linked members are stored permanently under the employee.</div>
        </div>
      ...
      <table class="ep-table">
        ...
        <tbody>
          ...
          <tr class="{{ $member['is_family_head'] ? 'ep-family-head' : '' }}">
            ...
            <td><span class="ep-status">{{ $member['current_status'] }}</span></td>
  ...
  <section id="profile-tab-history" class="ep-panel">
    <div class="ep-card">
      <div class="ep-card-head"><div><h3 class="ep-card-title">Non-Billing History</h3><div class="ep-card-sub">Residence, family movement and asset history will appear here when transaction workflows are implemented.</div></div></div>
      <div class="ep-empty">No non-billing movement records are connected to this profile yet.</div>
    </div>
  </section>
</div>
